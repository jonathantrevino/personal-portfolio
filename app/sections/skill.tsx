        ...
        {skills.map((skill, index) => (
          ...
          >
            ...
            <div className='w-full  relative h-full flex justify-center z-[10]'>
              <div className="group-hover:scale-100 scale-50 group-hover:opacity-100 group-hover:bg-[color:var(--skill-image)] rounded-md px-2 opacity-0 absolute bottom-1 block shadow-lg group-hover:z-20 text-xs md:text-sm  transition-all">
